...
insert into products (name, description, code, price) values ('Sweet Sweet Gummies', 'Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id.', '816905633-0', 10.5);
...
insert into products (name, description, code, price) values ('Velvet silvermine', 'Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla.', '492662523-7', 14);
